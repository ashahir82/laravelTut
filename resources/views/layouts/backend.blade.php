...
<div class="navbar navbar-default header-highlight">
    <div class="navbar-header">
        <a class="navbar-brand" href="/home"><img src="/themes/limitless/assets/images/1master.png" alt=""></a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a href="/admin/user/profile"><i class="icon-user-plus"></i> My profile</a></li>
                        <li><a href="/admin/user/change-password"><i class="icon-cog5"></i> Change Password</a></li>
                        <li class="divider"></li>
        ...
        <div class="content-wrapper">
            ...
            <!-- Footer -->
                <div class="footer text-muted">
                    &copy; {{ \Carbon\Carbon::now()->year }}. <a href="#">1Master</a> by <a href="http://mohr.gov.my">MOHR</a>
                </div>
                <!-- /footer -->
